<template>
  <div v-if="updateModalOpen" class="mypage-update-modal" tabindex="-1">
    ...
    <div class="modal-content">
      <svg class="modalbox" width="553" height="251" viewBox="0 0 553 251" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="modal-header">
        ...
        <button @click="$emit('update:updateModalOpen', !updateModalOpen)" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
        <div class="update-title">별명 수정</div>
        <div class="update-input-cont">
          <input
            class="update-input" 
            type="email"
            v-model="nick"
